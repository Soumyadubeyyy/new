      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-semibold tracking-tight max-w-2xl mx-auto">
            Ready to make WhatsApp <span className="gradient-text-emerald">work for you</span>?
          </h2>
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
            Join early access. Set up your organization in minutes. Get founder-tier pricing forever.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link to="/book-demo" className="inline-flex items-center gap-2 rounded-xl glass px-6 py-3 text-sm font-medium hover:bg-foreground/5 transition-colors">
              Book Demo
            </Link>
          </div>
        </motion.div>
    ...
    <footer className="border-t border-border/60 mt-10">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-primary to-violet-glow grid place-items-center font-display font-bold text-primary-foreground">S</div>
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-sm">
              A WhatsApp-native operating layer for teams that ship in the real world.
            </p>
            <div className="mt-5 flex gap-2">
              {[Twitter, Linkedin, Github].map((Icon, i) => (
                <a key={i} href="#" className="h-9 w-9 rounded-lg glass grid place-items-center hover:bg-foreground/5 transition-colors">
                  <Icon size={14} />
                </a>
              ))}
            </div>
          ...
          <FooterCol title="Product" links={["Features", "Dashboard", "How it works", "FAQ"]} />
        ...
        <div className="mt-12 pt-6 border-t border-border/60 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <span>© {new Date().getFullYear()} GooseLabs. All rights reserved.</span>
